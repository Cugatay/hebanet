<template>
    <div class="container w-full mx-auto">
      ...
      <div v-if="teachers != undefined" class="teachers">
        ...
        <div class="scroll teacher_cards mx-auto mt-4 mb-10 flex overflow-x-scroll w-11/12 pb-3">
            <div style="width:20000vw" class="flex">
            <UserCard v-for="teacher in teachers" :key="teacher.username" class="float-left ml-2" :username="teacher.username" :nameSurname="teacher.name" :workArea="teacher.work_area" :description="teacher.description" />
            </div>
        </div>
    </div>
        ...
        <div class="scroll student_cards mx-auto mt-4 mb-10 flex overflow-x-auto w-11/12 pb-3">
            <div style="width:20000vw" class="flex">
            <UserCard v-for="student in students" :key="student.username" class="float-left ml-2" :username="student.username" :nameSurname="student.name" :workArea="student.work_area" :description="student.description" />
            </div>
        </div>
       </div>
...
export default {
    ...
    asyncData(context, callback){
      context.$axios
          .post("/api/searchuser", { name: context.route.params.search_param, password:"", why:"userpage" })
          .then(result => {
